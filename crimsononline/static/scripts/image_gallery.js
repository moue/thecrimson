function center_gallery_image(){
    ...
    var img_url = $(".viewer_image").children("img").attr("src");
    ...
    if( mar ){
        $(".viewer_image").children("img").css("margin", mar + "px 0");
    }
}
        ...
        var inject_results = function(results){
            ...
            $(".viewer_image").fadeOut('fast', function(){
                $(".viewer_info").fadeOut('fast', function(){
                    $(".viewer_info").empty().append(res[1]);

                    $(".viewer_image").empty().append(res[0]);
